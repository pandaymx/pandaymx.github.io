...
## 为什么需要自托管 Runner {#why-self-hosted}
...
### GitHub-hosted vs Self-hosted 对比 {#comparison}
...
### 方式 1：Action Runner 包安装 {#package-installation}
...
### 方式 2：Docker 安装 {#docker-installation}
...
### 方式 3：Docker Compose 安装 {#docker-compose-installation}
...
### Ephemeral Runner（一次性 Runner）{#ephemeral-runner}
...
### 配置 GitHub App 认证 {#configure-github-app}
...
### 创建 RunnerDeployment {#create-runner-deployment}
...
### 基于队列长度的自动扩缩 {#queue-based-scaling}
...
### Runner 并发配置 {#runner-concurrency}
...
### Docker-in-Docker 权限问题 {#dind-permission}
...
### Runner 自动更新失败 {#auto-update-failed}
