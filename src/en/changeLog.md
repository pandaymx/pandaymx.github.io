...
- Add an NVIDIA page and related icons to the Artificial Intelligence navigation bar
- Add a CUDA page and related icons
...
- Add WSL icons and update WSL page titles and order
...
- Add database pages and related icons to the navigation bar and sidebar
- Add Redis pages and related icons to the database navigation bar
