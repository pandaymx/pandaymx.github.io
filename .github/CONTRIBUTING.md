# Contributing to pandaymx.github.io

First of all, thank you very much for taking the time to contribute to pandaymx.github.io! It is people like you that make pandaymx.github.io such a great project.
...
2. **Clone the repository to your local machine**:
   ...
   ```bash
   git clone https://github.com/your-username/pandaymx.github.io.git
   cd pandaymx.github.io
   ```
...
3. **Create a new branch**:
   ...
   ```bash
   git switch -c fix/your-bug-fix-name
   ```

4. **Install dependencies**: This project uses `bun` as the package manager.
